...
setup(
    ...
    url="https://github.com/Devtography/ibpy_native",  # Optional
    # This should be your name or the name of the organization which owns the
    # project.
    author="Wing Chau @Devtography",  # Optional
    # This should be a valid email address corresponding to the author listed
    # above.
    author_email="wing@devtography.com",  # Optional
    ...
    keywords="ibapi trading development",  # Optional
